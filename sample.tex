...
\HAWThesisProperties{Author={Shirin Bediako \\ MatrNr.: 2088775 \\ Fenglerstr. 26 \\ 22041 Hamburg \\ shirin.bediako@haw-hamburg.de}
                    ,Title={Institutionsanalyse der AWO Kindertagesstätte Lotte Lemke Halstenbek}
                    ,EnglishTitle={Institutionsanalyse der AWO Kindertagesstätte Lotte Lemke Halstenbek}
...
\input{kapitel/hauptteil/hauptteil}

%---------------------------------------------------------------------------------------------------
% Der dritte Teil der Arbeit
%---------------------------------------------------------------------------------------------------
\typeout{===== File: ZUSAMMENFASSUNG}
\input{kapitel/schluss/reflexion}
...
\includepdfset{pagecommand={\pagestyle{scrheadings}}}
\includepdf[pages=-, addtotoc={1,chapter,0,Berechnung für die Arbeit am Kind,chap:anhang_2}, scale=0.80, offset=6mm -5mm]{anhang_2.pdf} 
